...
const hero = () => {
  return (
    <div className=' w-full h-screen bg-zinc-100 ' >
        ...
        <div 
         style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1725663656850-7bc515816fcd?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)', // Replace with your image path
            backgroundSize: 'cover',
            backgroundPosition: 'center',
          }}
         className="page1 w-full h-screen realative p-2 ">
            <h1 className=' text-7xl text-zinc-200 mt-10  ml-2'>Calculate the Emissions of carbon from Mining</h1>
